...
//    idk what's up with this test class but it's trying to test methods that don't exist like ship.setOccpupiedSquare which isn't a method in the ship class
//    @Before
